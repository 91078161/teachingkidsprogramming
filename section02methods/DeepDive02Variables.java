...
public class DeepDive02Variables
{
  ...
  @Test
  public void methodsReturnValuesAndVariablesExistsWithinMethods() throws Exception
  {
    String exam = "work";
    exam = life();
  ...
  /**
   * Ignore the following, It's needed to
   *  run the deep dive
   * 
   * 
   * 
  ...
  @Test
  public void youcanmultiplyandsubtract() throws Exception
  {
    int numberOfBerries = 5 * 5 - 3;
    Assert.assertEquals(numberOfBerries, 22);
  }
}
